...
/*        else if(gp.ui.titleScreenState == 1) {
    ...
    public void playState(int code) {
        ...
        if(code == KeyEvent.VK_N) {
            ...
            randomName = fName.get(0).toString() + " " + lName.get(0).toString();
            
            gp.addNPCTwitch(gp.currentMap, null, gp.player.worldX + gp.tileSize, gp.player.worldY, randomName);
            try {
